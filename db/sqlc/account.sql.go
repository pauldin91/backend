...
type AllAccountsParams struct {
	Limit  int32 `json:"limit"`
	Offset int32 `json:"offset"`
}

func (q *Queries) AllAccounts(ctx context.Context, arg AllAccountsParams) ([]Account, error) {
	rows, err := q.db.Query(ctx, allAccounts, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
