...
// Source: github.com/pauldin91/backend/db/sqlc (interfaces: Store)
//
...
import (
	...
	sqlc "github.com/pauldin91/backend/db/sqlc"
...
func (m *MockStore) AllAccounts(ctx context.Context, arg sqlc.AllAccountsParams) ([]sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllAccounts", ctx, arg)
	ret0, _ := ret[0].([]sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) AllAccounts(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllAccounts", reflect.TypeOf((*MockStore)(nil).AllAccounts), ctx, arg)
}
